...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setUpView()   //Initializing Widget's
    ...
    fun getTestInfo() {
        ...
        GameService.getTestInfo(alt, token, object : FireBaseStorageCallback<TestInfo, Throwable> {
            ...
            override fun onSuccess(result: TestInfo) {
                ...
                setData()    //Puting the Data to Widget and set the Var's
            }
    ...
    fun setUpView() {
        ...
        txtH0.setOnClickListener {
            ...
            /**
             * Sene the Data to Activity Result
             */
        ...
        /**
         * Skip from currecn Queston and go to the next Question
         */
